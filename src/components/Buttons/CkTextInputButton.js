...
const CkTextInputButton = ({text, setText, backgroundColor, title, onSign, buttonText}) => {
  return (
    <View style={{backgroundColor:backgroundColor, marginBottom: 10,width:'100%', paddingVertical: 10, flexDirection:'row', backgroundColor: backgroundColor, padding:10, borderRadius: 4, alignItems:'center',  }}>
        ...
        <View style={{flex: 1.4, justifyContent: 'center', alignItems: 'center',  marginLeft: 10}}>
        <CkButton backgroundColor={backgroundColor} onPress={onSign} text={buttonText} />
